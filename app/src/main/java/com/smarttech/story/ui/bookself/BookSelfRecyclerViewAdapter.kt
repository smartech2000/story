...
class BookSelfRecyclerViewAdapter(
    ...
    class ViewHolder private constructor(val binding: FragmentBookselfBinding) :
        RecyclerView.ViewHolder(binding.root) {

        fun bind(item: Function, clickListener: FunctionListener) {
            binding.bookself = item
        ...
        companion object {
            fun from(parent: ViewGroup): ViewHolder {
                ...
                val binding = FragmentBookselfBinding.inflate(layoutInflater, parent, false)
